...
The first two columns are subject and activity are indentifiers

1. Subject - the ID of the subject
2. Activity - the Name of the Activity performed by the subject when measurements were taken

MEASUREMENTS:
The variables remaining are just calculated means and standard deviations of these sets of data:
